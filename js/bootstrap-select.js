...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Limite alcanzado ({n} registro maximo)' : 'Limite alcanzado ({n} registros maximos)',
        (numGroup == 1) ? 'Limite del grupo alcanzado ({n} registro maximo)' : 'Limite del grupo alzanzado ({n} registros maximos)'
      ];
    },
